...
export default function About() {
  ...
  return (
    <>
      <Helmet>
        <title>About Us | BlogWave</title>
        <meta name="description" content="Learn about the team behind BlogWave and our mission to revolutionize blogging with modern technology." />
        <meta property="og:title" content="About Us | BlogWave" />
        <meta property="og:description" content="Learn about the team behind BlogWave and our mission to revolutionize blogging with modern technology." />
      ...
      <AnimatedSection className="pt-32 pb-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            >
              About <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">BlogWave</span>
            </motion.h1>
            <motion.p 
            ...
            >
              Revolutionizing the blogging experience with modern technology
            </motion.p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                At BlogWave, we believe that content creators deserve powerful, beautiful tools that help their ideas reach the world. We're on a mission to democratize publishing by combining enterprise-grade features with intuitive design.
              </p>
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                Meet the passionate individuals behind BlogWave who are dedicated to building the future of blogging technology.
              </p>
            </div>
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                The principles that guide everything we do at BlogWave.
              </p>
            </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="mb-8 md:mb-0 md:mr-12 text-white">
                  ...
                  <p className="text-white/90 text-lg mb-6">
                    Start your blogging journey with BlogWave today.
                  </p>
