      ...
      <div className="relative z-10 container mx-auto px-4 pt-24 pb-20 md:pt-32 md:pb-32">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          >
            ...
            <div className="relative inline-block mb-6">
              ...
              <span className="text-base uppercase tracking-widest font-medium text-primary/80 px-4 py-2 border border-primary/20 rounded-full bg-background/80 backdrop-blur-sm">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-serif font-bold tracking-tight leading-tight mb-8">
              ...
              <motion.span
                ...
                className="block text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary/80 mb-2 dark:text-white dark:bg-none"
              >
            ...
            >
              ...
              <div className="relative bg-background/90 backdrop-blur-sm p-6 rounded-lg border border-primary/10 shadow-xl">
                <h3 className="text-xl font-semibold mb-4 font-serif">Join Our Community</h3>
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col sm:flex-row gap-3">
                          ...
                          <FormItem>
                            <FormControl>
                              <Input 
                                ...
                                {...field} 
                                className="h-12 px-4 focus-visible:ring-primary border-primary/20"
                              />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                    ...
                    <Button 
                      type="submit" 
                      size="lg"
                      className="h-12 px-6 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary font-medium"
                      disabled={isLoading}
                    >
                      {isLoading ? (
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -top-4 -left-4 w-full h-full bg-primary/5 rounded-lg transform rotate-3"></div>
              <div className="absolute -bottom-4 -right-4 w-full h-full bg-secondary/5 rounded-lg transform -rotate-2"></div>
              
              {/* Main featured card */}
              <div className="relative rounded-xl overflow-hidden shadow-2xl border border-primary/10 backdrop-blur-sm">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              {[
                ...
                <motion.div 
                  ...
                  className="relative overflow-hidden rounded-lg shadow-md border border-primary/10"
                >
                  <img 
                    src={post.image} 
                    alt={post.title}
        ...
        >
          <div className="text-primary/60 flex flex-col items-center">
            <p className="text-sm mb-2 font-serif">Scroll to explore</p>
            <svg 
